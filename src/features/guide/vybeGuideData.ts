...
export const VYBE_GUIDE_ITEMS: VybeGuideItem[] = [
  ...
  },
  {
    ...
    where: "Look for lock icons and Learn how this helps throughout Creator HQ. Compare complete limits and plan availability under Creator Settings > Membership.",
  ...
  },
  {
    ...
    where: "Creator HQ > Profile & Growth > Public Profile & Discovery.",
    route: "/profile",
    roles: ["creator", "admin"],
  ...
  },
  {
    ...
    where: "Creator HQ > Music Library.",
    route: "/music",
    roles: ["creator", "admin"],
  ...
  },
  {
    ...
    where: "Creator HQ > Playlists. Open a playlist to manage songs and sharing.",
    route: "/playlists",
    roles: ["creator", "admin"],
  ...
  },
  {
    ...
    where: "Creator HQ > Audience > Insights.",
    route: "/creator-analytics",
    roles: ["creator", "admin"],
  ...
  },
  {
    ...
    where: "Creator HQ > Audience > Connections.",
    route: "/connections",
    roles: ["creator", "admin"],
  ...
  },
  {
    ...
    where: "Creator HQ > Video Library.",
    route: "/videos",
    roles: ["creator", "admin"],
  ...
  },
  {
    ...
    where: "Creator HQ > Film Studio and Project Media & Review.",
    route: "/film-studio",
    roles: ["creator", "admin"],
  ...
  },
  {
    ...
    where: "Creator HQ > Profile & Growth > Industry Kit & EPK.",
    route: "/epk",
    roles: ["creator", "admin"],
