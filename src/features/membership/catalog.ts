...
export const CREATOR_PLAN_CATALOG: CreatorPlanCatalogEntry[] = [
  {
    ...
    highlights: [
      ...
      "Short video preview planned after video launches",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Video and AI allowances activate when those tools launch",
    ],
    launchState: "planned",
  },
  {
    ...
    highlights: [
      "Music videos, short films, interviews, and episodes",
  ...
  },
  {
    ...
    highlights: [
      "Five team members with controlled permissions",
