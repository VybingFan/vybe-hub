...
export const ROUTE_ACCESS_REGISTRY: readonly RouteAccessRule[] = [
  ...
  { id: "public-creators", experience: "public", paths: ["/creator/:username", "/artist/:username", "/artist/:username/playlist/:slug", "/playlist/:slug", "/video/:videoId"], protection: ["public"], followUp: "V24.44E" },
