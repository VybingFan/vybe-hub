...
export const ROUTE_ACCESS_REGISTRY: readonly RouteAccessRule[] = [
  ...
  { id: "creator-help-support", experience: "creator_studio", paths: ["/creator-support"], roles: creatorRoles, protection: ["session", "role"] },
  ...
  { id: "member-experience", experience: "supporter", paths: ["/home", "/discover", "/social-search", "/listen", "/watch", "/read", "/play", "/my-vybe", "/communities", "/events"], roles: sharedRoles, protection: ["session", "role"] },
